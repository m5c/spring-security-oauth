...
public class StockProxyController {
  ...
  public int getBumpedUpStock(@RegisteredOAuth2AuthorizedClient("stock-client-authorization-code")
    ...
    // token MUST be sent here, because this is still a protected resource.
    String blockedResource = "http://127.0.0.1:8090/bookstore/stocklocations";
    String locations = this.webClient.get().uri(blockedResource)
